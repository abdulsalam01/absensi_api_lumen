              ...
              <div class="card-body">
                ...
                <form action="#" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="npm" class="form-control" placeholder="2016110073" v-model="datas.npm"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nama" class="form-control" placeholder="John Jiff" v-model="datas.nama"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="alamat" class="form-control" placeholder="Jl. Kopo" v-model="datas.alamat"></textarea>
                    </div>
                  </div>
